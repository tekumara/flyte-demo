...
from aircraft.etl_flow import CLEANED_AIRCRAFT_COLS, extract_live_data, extract_reference_data, transform


def test_extract_live_data():
    df = extract_live_data()
